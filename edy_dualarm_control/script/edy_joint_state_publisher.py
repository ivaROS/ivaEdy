...
class JointStatePublisher():
	...
	self.l_joint8name = ''
        ...
        self.r_joint1name = ''
        self.r_joint1current_pos = 0.0
        self.r_joint1velocity = 0.0
        self.r_joint1load = 0.0

	self.r_joint2name = ''
        self.r_joint2current_pos = 0.0
        self.r_joint2velocity = 0.0
        self.r_joint2load = 0.0

        self.r_joint3name = ''
        self.r_joint3current_pos = 0.0
        self.r_joint3velocity = 0.0
        self.r_joint3load = 0.0

	self.r_joint4name = ''
        self.r_joint4current_pos = 0.0
        self.r_joint4velocity = 0.0
        self.r_joint4load = 0.0

        self.r_joint5name = ''
        self.r_joint5current_pos = 0.0
        self.r_joint5velocity = 0.0
        self.r_joint5load = 0.0

	self.r_joint6name = ''
        self.r_joint6current_pos = 0.0
        self.r_joint6velocity = 0.0
        self.r_joint6load = 0.0

        self.r_joint7name = ''
        self.r_joint7current_pos = 0.0
        self.r_joint7velocity = 0.0
        self.r_joint7load = 0.0

	self.r_joint8name = ''
        self.r_joint8current_pos = 0.0
        self.r_joint8velocity = 0.0
        self.r_joint8load = 0.0       
	...
	rospy.Subscriber('/edy_position_controller_l_8/state', JointStateDynamixel, self.controller_state_handler_l_8)
        ...
        rospy.Subscriber('/edy_position_controller_r_1/state', JointStateDynamixel, self.controller_state_handler_r_1)
	rospy.Subscriber('/edy_position_controller_r_2/state', JointStateDynamixel, self.controller_state_handler_r_2)
        rospy.Subscriber('/edy_position_controller_r_3/state', JointStateDynamixel, self.controller_state_handler_r_3)
	rospy.Subscriber('/edy_position_controller_r_4/state', JointStateDynamixel, self.controller_state_handler_r_4)
        rospy.Subscriber('/edy_position_controller_r_5/state', JointStateDynamixel, self.controller_state_handler_r_5)
	rospy.Subscriber('/edy_position_controller_r_6/state', JointStateDynamixel, self.controller_state_handler_r_6)
        rospy.Subscriber('/edy_position_controller_r_7/state', JointStateDynamixel, self.controller_state_handler_r_7)
	rospy.Subscriber('/edy_position_controller_r_8/state', JointStateDynamixel, self.controller_state_handler_r_8)
    ...
    def controller_state_handler_r_1(self, msg):
        self.r_joint1name = msg.name
        self.r_joint1current_pos = msg.current_pos
        self.r_joint1velocity = msg.velocity
        self.r_joint1load = msg.load

    def controller_state_handler_r_2(self, msg):
        self.r_joint2name = msg.name
        self.r_joint2current_pos = msg.current_pos
        self.r_joint2velocity = msg.velocity
        self.r_joint2load = msg.load

    def controller_state_handler_r_3(self, msg):
        self.r_joint3name = msg.name
        self.r_joint3current_pos = msg.current_pos
        self.r_joint3velocity = msg.velocity
        self.r_joint3load = msg.load

    def controller_state_handler_r_4(self, msg):
        self.r_joint4name = msg.name
        self.r_joint4current_pos = msg.current_pos
        self.r_joint4velocity = msg.velocity
        self.r_joint4load = msg.load

    def controller_state_handler_r_5(self, msg):
        self.r_joint5name = msg.name
        self.r_joint5current_pos = msg.current_pos
        self.r_joint5velocity = msg.velocity
        self.r_joint5load = msg.load

    def controller_state_handler_r_6(self, msg):
        self.r_joint6name = msg.name
        self.r_joint6current_pos = msg.current_pos
        self.r_joint6velocity = msg.velocity
        self.r_joint6load = msg.load

    def controller_state_handler_r_7(self, msg):
        self.r_joint7name = msg.name
        self.r_joint7current_pos = msg.current_pos
        self.r_joint7velocity = msg.velocity
        self.r_joint7load = msg.load

    def controller_state_handler_r_8(self, msg):
        self.r_joint8name = msg.name
        self.r_joint8current_pos = msg.current_pos
        self.r_joint8velocity = msg.velocity
        self.r_joint8load = msg.load
    ...
    def publish_joint_states(self):
        ...
        msg.name.append(self.r_joint1name)
        msg.position.append(self.r_joint1current_pos)
        msg.velocity.append(self.r_joint1velocity)
        msg.effort.append(self.r_joint1load)

        msg.name.append(self.r_joint2name)
        msg.position.append(self.r_joint2current_pos)
        msg.velocity.append(self.r_joint2velocity)
        msg.effort.append(self.r_joint2load)

        msg.name.append(self.r_joint3name)
        msg.position.append(self.r_joint3current_pos)
        msg.velocity.append(self.r_joint3velocity)
        msg.effort.append(self.r_joint3load)

        msg.name.append(self.r_joint4name)
        msg.position.append(self.r_joint4current_pos)
        msg.velocity.append(self.r_joint4velocity)
        msg.effort.append(self.r_joint4load)

        msg.name.append(self.r_joint5name)
        msg.position.append(self.r_joint5current_pos)
        msg.velocity.append(self.r_joint5velocity)
        msg.effort.append(self.r_joint5load)

        msg.name.append(self.r_joint6name)
        msg.position.append(self.r_joint6current_pos)
        msg.velocity.append(self.r_joint6velocity)
        msg.effort.append(self.r_joint6load)

        msg.name.append(self.r_joint7name)
        msg.position.append(self.r_joint7current_pos)
        msg.velocity.append(self.r_joint7velocity)
        msg.effort.append(self.r_joint7load)

        msg.name.append(self.r_joint8name)
        msg.position.append(self.r_joint8current_pos)
        msg.velocity.append(self.r_joint8velocity)
        msg.effort.append(self.r_joint8load)
